...
enum opt_code
{
  ...
  OPT_maccumulate_args = 1039,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1040,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1041,                /* -mcall-prologues */
  OPT_mdeb = 1042,                           /* -mdeb */
  OPT_mfract_convert_truncate = 1043,        /* -mfract-convert-truncate */
  OPT_mint8 = 1044,                          /* -mint8 */
  OPT_mlog_ = 1045,                          /* -mlog= */
  OPT_mmcu_ = 1046,                          /* -mmcu= */
  OPT_mno_interrupts = 1047,                 /* -mno-interrupts */
  OPT_morder1 = 1048,                        /* -morder1 */
  OPT_morder2 = 1049,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1050,              /* -mpmem-wrap-around */
  OPT_mrelax = 1051,                         /* -mrelax */
  OPT_msp8 = 1052,                           /* -msp8 */
  OPT_mstrict_X = 1053,                      /* -mstrict-X */
  OPT_mtiny_stack = 1054,                    /* -mtiny-stack */
  OPT_n = 1055,                              /* -n */
  ...
  OPT_quiet = 1083,                          /* -quiet */
  OPT_r = 1084,                              /* -r */
  OPT_remap = 1085,                          /* -remap */
  OPT_s = 1086,                              /* -s */
  OPT_s_bc_abi = 1087,                       /* -s-bc-abi */
  OPT_save_temps = 1088,                     /* -save-temps */
  OPT_save_temps_ = 1089,                    /* -save-temps= */
  OPT_shared = 1090,                         /* -shared */
  OPT_shared_libgcc = 1091,                  /* -shared-libgcc */
  /* OPT_specs = 1092, */                    /* -specs */
  OPT_specs_ = 1093,                         /* -specs= */
  OPT_static = 1094,                         /* -static */
  OPT_static_libasan = 1095,                 /* -static-libasan */
  OPT_static_libgcc = 1096,                  /* -static-libgcc */
  OPT_static_libgcj = 1097,                  /* -static-libgcj */
  OPT_static_libgfortran = 1098,             /* -static-libgfortran */
  OPT_static_libgo = 1099,                   /* -static-libgo */
  OPT_static_libstdc__ = 1100,               /* -static-libstdc++ */
  OPT_static_libtsan = 1101,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1102, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1103, */                /* -std=c++0x */
  OPT_std_c__11 = 1104,                      /* -std=c++11 */
  OPT_std_c__1y = 1105,                      /* -std=c++1y */
  OPT_std_c__98 = 1106,                      /* -std=c++98 */
  OPT_std_c11 = 1107,                        /* -std=c11 */
  /* OPT_std_c1x = 1108, */                  /* -std=c1x */
  /* OPT_std_c89 = 1109, */                  /* -std=c89 */
  OPT_std_c90 = 1110,                        /* -std=c90 */
  OPT_std_c99 = 1111,                        /* -std=c99 */
  /* OPT_std_c9x = 1112, */                  /* -std=c9x */
  OPT_std_f2003 = 1113,                      /* -std=f2003 */
  OPT_std_f2008 = 1114,                      /* -std=f2008 */
  OPT_std_f2008ts = 1115,                    /* -std=f2008ts */
  OPT_std_f95 = 1116,                        /* -std=f95 */
  OPT_std_gnu = 1117,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1118, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1119, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1120,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1121,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1122,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1123,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1124, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1125, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1126,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1127,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1128, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1129, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1130,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1131, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1132, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1133, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1134,                     /* -std=legacy */
  OPT_symbolic = 1135,                       /* -symbolic */
  OPT_t = 1136,                              /* -t */
  OPT_time = 1137,                           /* -time */
  OPT_time_ = 1138,                          /* -time= */
  OPT_traditional = 1139,                    /* -traditional */
  OPT_traditional_cpp = 1140,                /* -traditional-cpp */
  OPT_trigraphs = 1141,                      /* -trigraphs */
  OPT_u = 1142,                              /* -u */
  OPT_undef = 1143,                          /* -undef */
  OPT_v = 1144,                              /* -v */
  OPT_version = 1145,                        /* -version */
  OPT_w = 1146,                              /* -w */
  OPT_wrapper = 1147,                        /* -wrapper */
  OPT_x = 1148,                              /* -x */
  OPT_z = 1149,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
