...
## Serial communication
 ...
 - `SWIO=<0|1> RX=... TX=... BAUD_RATE=<baud>`
   ...
   | `SWIO=1` (16-bit PC) | F<sub>CPU</sub>/1560 | F<sub>CPU</sub>/29 | 10,300 baud | 550,000 baud |
   | `SWIO=1` (22-bit PC) | F<sub>CPU</sub>/1560 | F<sub>CPU</sub>/33 | 10,300 baud | 480,000 baud |
