...
#define MASK_ABSDATA (1 << 0)
#define MASK_ACCUMULATE_OUTGOING_ARGS (1 << 1)
#define MASK_CALL_PROLOGUES (1 << 2)
#define MASK_ALL_DEBUG (1 << 3)
#define MASK_FRACT_CONV_TRUNC (1 << 4)
#define MASK_INT8 (1 << 5)
#define MASK_NO_INTERRUPTS (1 << 6)
#define MASK_ORDER_1 (1 << 7)
#define MASK_ORDER_2 (1 << 8)
#define MASK_RMW (1 << 9)
#define MASK_SHORT_CALLS (1 << 10)
#define MASK_SKIP_BUG (1 << 11)
#define MASK_TINY_STACK (1 << 12)
...
enum opt_code
{
  ...
  OPT_Wabi_ = 161,                           /* -Wabi= */
  OPT_Waddr_space_convert = 162,             /* -Waddr-space-convert */
  ...
  OPT_Wmisspelled_isr = 299,                 /* -Wmisspelled-isr */
  ...
  OPT_mabsdata = 1138,                       /* -mabsdata */
  OPT_maccumulate_args = 1139,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1140,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1141,                /* -mcall-prologues */
  OPT_mdeb = 1142,                           /* -mdeb */
  OPT_mfract_convert_truncate = 1143,        /* -mfract-convert-truncate */
  OPT_mint8 = 1144,                          /* -mint8 */
  OPT_mlog_ = 1145,                          /* -mlog= */
  OPT_mmcu_ = 1146,                          /* -mmcu= */
  OPT_mn_flash_ = 1147,                      /* -mn-flash= */
  OPT_mno_interrupts = 1148,                 /* -mno-interrupts */
  OPT_mnon_bit_addressable_registers_mask_ = 1149,/* -mnon-bit-addressable-registers-mask= */
  OPT_morder1 = 1150,                        /* -morder1 */
  OPT_morder2 = 1151,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1152,              /* -mpmem-wrap-around */
  OPT_mrelax = 1153,                         /* -mrelax */
  OPT_mrmw = 1154,                           /* -mrmw */
  OPT_mshort_calls = 1155,                   /* -mshort-calls */
  OPT_mskip_bug = 1156,                      /* -mskip-bug */
  OPT_msp8 = 1157,                           /* -msp8 */
  OPT_mstrict_X = 1158,                      /* -mstrict-X */
  OPT_mtiny_stack = 1159,                    /* -mtiny-stack */
  OPT_n = 1160,                              /* -n */
  OPT_no_canonical_prefixes = 1161,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1162,              /* -no-integrated-cpp */
  OPT_nocpp = 1163,                          /* -nocpp */
  OPT_nodefaultlibs = 1164,                  /* -nodefaultlibs */
  OPT_nodevicelib = 1165,                    /* -nodevicelib */
  OPT_nostartfiles = 1166,                   /* -nostartfiles */
  OPT_nostdinc = 1167,                       /* -nostdinc */
  OPT_nostdinc__ = 1168,                     /* -nostdinc++ */
  OPT_nostdlib = 1169,                       /* -nostdlib */
  OPT_o = 1170,                              /* -o */
  OPT_p = 1171,                              /* -p */
  OPT_pass_exit_codes = 1172,                /* -pass-exit-codes */
  /* OPT_pedantic = 1173, */                 /* -pedantic */
  OPT_pedantic_errors = 1174,                /* -pedantic-errors */
  OPT_pg = 1175,                             /* -pg */
  OPT_pie = 1176,                            /* -pie */
  OPT_pipe = 1177,                           /* -pipe */
