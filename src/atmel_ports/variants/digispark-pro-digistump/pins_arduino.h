...
#define NUM_ANALOG_INPUTS    11 // A3, A5, A6, ..., A13 (that's 10, but ADC8 is used for XTAL and therefore out)

// map x from Ax to the digital pin number
#define analogInputToDigitalPin(p)  ((p) == 3 || ((p) >= 5 && (p)<=13)? (p): -1)
